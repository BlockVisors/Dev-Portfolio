...
export default [{
  ...
  render: (
    <div className='portfolio-item'>
      ...
      <div className='portfolio-item__links'>
        ...
        <a target="_blank" rel="noopener noreferrer" href="https://github.com/flexdinesh/typy">Code Repo</a>
      </div>
    </div>
  )
}, {
  ...
  render: (
    <div className='portfolio-item'>
      ...
      <div className='portfolio-item__links'>
        ...
        <a target="_blank" rel="noopener noreferrer" href="https://github.com/flexdinesh/dev-landing-page">Code Repo</a>
      </div>
    </div>
  )
}, {
  ...
  render: (
    <div className='portfolio-item'>
      ...
      <div className='portfolio-item__links'>
        ...
        <a target="_blank" rel="noopener noreferrer" href="https://github.com/flexdinesh/react-redux-boilerplate">Code Repo</a>
      </div>
    </div>
  )
}, {
  ...
  render: (
    <div className='portfolio-item'>
      ...
      <div className='portfolio-item__links'>
        ...
        <a target="_blank" rel="noopener noreferrer" href="https://github.com/flexdinesh/npm-module-boilerplate">Code Repo</a>
      </div>
    </div>
  )
}, {
  ...
  render: (
    <div className='portfolio-item'>
      ...
      <div className='portfolio-item__links'>
        <a target="_blank" rel="noopener noreferrer" href="https://github.com/flexdinesh/axios-retry-interceptor">Code Repo</a>
      </div>
    </div>
  )
}, {
  ...
  render: (
    <div className='portfolio-item'>
      ...
      <div className='portfolio-item__links'>
        ...
        <a target="_blank" rel="noopener noreferrer" href="https://github.com/flexdinesh/browser-or-node">Code Repo</a>
      </div>
    </div>
  )
}]